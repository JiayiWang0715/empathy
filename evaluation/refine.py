...
def _natural_common_response(user_message, failures, understanding):
    ...
    if "too_short" in failures or "generic_empathy" in failures:
        return (
            ...
            "It makes sense that you would want more than a generic reassurance here. "
            "You deserve a response that stays with the specific weight of what happened."
        )
...
def _natural_subtle_response(user_message, failures, understanding):
    ...
    return (
        f"There is a quiet heaviness in {hint}. "
        "Even without naming the feeling directly, it makes sense that this would leave you tense, worn down, or unsure what to do next. "
